...
#define CVAR_MANAGED_USERINFO		0x4000  // values managed by master server. Userinfo values that are encoded by master server and passed
										// in encoded form to the game server
